...
function updateTotalAmount() {
  ...
  var totalAmount = totalPrice1 + totalPrice2 + totalPrice3 + totalPrice4 + totalPrice5 + totalPrice6 + totalPrice7 + totalPrice8 + totalPrice9 + laborPrice;
...
doc.text(place, 147, 52, { maxWidth: 37 }); // Maximum width set to 67
  ...
  const rows = ['nme1', 'nme2', 'nme3', 'nme4','nme5','nme6','nme7','nme8','nme9','labour'];
  console.log(rows)
